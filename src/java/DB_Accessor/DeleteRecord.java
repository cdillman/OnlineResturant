 ...
 * @author Corbin
 */
public class DeleteRecord implements DBStrategy{
    ...
    public void DeleteRecord(){
        DeleteRecord db = new DeleteRecord();
       ...
       int updateCount;
       int deleteId = Integer.parseInt(record); // replace this with an existing id to delete
